      ...
      <DrawerContent>
        ...
        <DrawerBody paddingTop="10vh">
          <VStack s={20}>
            ...
            <Text fontSize="2xl"><Link href={`/discover/${tobase64(data || '')}`}>Discover</Link></Text>
            ...
            <Text fontSize="2xl"><Link href={`/books/${tobase64(data || '')}`}>Books</Link></Text>
            <Text fontSize="2xl"><Link href={`/animes/${tobase64(data || '')}`}>Animes</Link></Text>
          </VStack>
        </DrawerBody>
        <DrawerFooter>
