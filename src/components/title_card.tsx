...
import {
  ...
  ModalBody, Flex, Image, Text, Grid, Heading, GridItem, Box, Button
        ...
        <ModalBody bg="rgba(34, 34, 34, 0.7)" w="60vw">
          <Flex flexDirection="row">
            ...
            <Flex flexDir="column" p={10} justifyContent='space-between'>
              <Heading paddingTop={10} paddingLeft={25} size="2xl" color="white">{title.name}</Heading>
              <Grid p={25} templateColumns='repeat(3, 1fr)' justifyContent='space-between' templateRows='repeat(2,1fr)'>
                ...
                <GridItem>
                  <Text fontSize='lg' color="white" fontWeight="bold">{title.year}</Text>
                </GridItem>
                <GridItem>
                  <Text fontSize='lg' color="white" fontWeight="bold">{title.rating}</Text>
                </GridItem>
                <GridItem>
